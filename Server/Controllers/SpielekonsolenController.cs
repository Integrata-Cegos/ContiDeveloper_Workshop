...
[ApiController]
[Route("api/Spielekonsolen")]
public class SpielekonsolenController : ControllerBase
{
    private IGenericService<Spielekonsole> _service;

    public SpielekonsolenController(IGenericService<Spielekonsole> service)
    {
        _service = service;
    }
